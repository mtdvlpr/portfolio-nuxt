  ...
  netlify: {
    headers: {
      '/*': [
        ...
        "Content-Security-Policy: default-src 'none'; style-src 'self' 'unsafe-inline'; script-src 'self' https://cdn.jsdelivr.net 'sha256-hZEJlT4J/GD2uG4KHrmDGqvW/AXnWJnOEp22S3bmm+Y=' 'sha256-VnowBIfh7Mn1b3crrY5ydHx82AQMNQ9QcDlnLU+O7Rw=' 'sha256-yX/iyX7D+2AX+qF0YUk4EXLqu5fIbl/NS5QXjj9BX4M='; img-src data: 'self'; connect-src 'self'; manifest-src 'self';",
      ],
    },
  },
